module.exports = function (grunt) {
  ...
  grunt.registerTask('build', [ 'newer:copy:npm', 'phplint', 'eslint', 'concat', 'string-replace', 'uglify', 'import_sass_from_dirs', 'sass', 'postcss', 'clean', 'copy:pdf', 'imagemin', 'svgstore' ]);
